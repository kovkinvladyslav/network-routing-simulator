...
void EdgeItem::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->requestRemove((*reinterpret_cast< std::add_pointer_t<EdgeItem*>>(_a[1]))); break;
        default: ;
        }
    }
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (EdgeItem::*)(EdgeItem * )>(_a, &EdgeItem::requestRemove, 0))
            return;
    }
}
...
// SIGNAL 0
void EdgeItem::requestRemove(EdgeItem * _t1)
{
